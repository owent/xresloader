...
public final class Xresloader extends com.google.protobuf.GeneratedFile {
  private Xresloader() {}
  static {
  ...
  public enum ListStripOption
    ...
    public static com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return org.xresloader.Xresloader.getDescriptor().getEnumType(0);
    }
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ptions\030\352\007 \003(\tB7Z5github.com/xresloader/x" +
      "resloader;xresloader_extensionb\006proto3"
    };
    ...
    fileDescription.internalInit(descriptor.getExtension(0));
    msgDescription.internalInit(descriptor.getExtension(1));
    msgRequireMappingAll.internalInit(descriptor.getExtension(2));
    msgSeparator.internalInit(descriptor.getExtension(3));
    validator.internalInit(descriptor.getExtension(4));
    fieldUniqueTag.internalInit(descriptor.getExtension(5));
    fieldNotNull.internalInit(descriptor.getExtension(6));
    mapKeyValidator.internalInit(descriptor.getExtension(7));
    mapValueValidator.internalInit(descriptor.getExtension(8));
    verifier.internalInit(descriptor.getExtension(9));
    fieldDescription.internalInit(descriptor.getExtension(10));
    fieldAlias.internalInit(descriptor.getExtension(11));
    fieldRatio.internalInit(descriptor.getExtension(12));
    fieldSeparator.internalInit(descriptor.getExtension(13));
    fieldRequired.internalInit(descriptor.getExtension(14));
    fieldOriginValue.internalInit(descriptor.getExtension(15));
    fieldAllowMissingInPlainMode.internalInit(descriptor.getExtension(16));
    fieldListStripOption.internalInit(descriptor.getExtension(17));
    fieldListMinSize.internalInit(descriptor.getExtension(18));
    fieldListMaxSize.internalInit(descriptor.getExtension(19));
    fieldListStrictSize.internalInit(descriptor.getExtension(20));
    fieldTag.internalInit(descriptor.getExtension(21));
    oneofDescription.internalInit(descriptor.getExtension(22));
    oneofSeparator.internalInit(descriptor.getExtension(23));
    oneofNotNull.internalInit(descriptor.getExtension(24));
    oneofAllowMissingInPlainMode.internalInit(descriptor.getExtension(25));
    oneofTag.internalInit(descriptor.getExtension(26));
    enumDescription.internalInit(descriptor.getExtension(27));
    enumvDescription.internalInit(descriptor.getExtension(28));
    enumAlias.internalInit(descriptor.getExtension(29));
