...
public final class XresloaderUe extends com.google.protobuf.GeneratedFile {
  ...
  public enum loader_mode
    ...
    public static com.google.protobuf.Descriptors.EnumDescriptor
        getDescriptor() {
      return org.xresloader.ue.XresloaderUe.getDescriptor().getEnumType(0);
    }
  ...
  static {
    ...
    keyTag.internalInit(descriptor.getExtension(0));
    ueTypeName.internalInit(descriptor.getExtension(1));
    ueTypeIsClass.internalInit(descriptor.getExtension(2));
    ueOriginTypeName.internalInit(descriptor.getExtension(3));
    ueOriginTypeDefaultValue.internalInit(descriptor.getExtension(4));
    helper.internalInit(descriptor.getExtension(5));
    notDataTable.internalInit(descriptor.getExtension(6));
    defaultLoader.internalInit(descriptor.getExtension(7));
    includeHeader.internalInit(descriptor.getExtension(8));
