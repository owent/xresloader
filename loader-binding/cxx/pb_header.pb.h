...
inline std::string* xresloader_data_source::release_sheet() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return sheet_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline std::string* xresloader_header::release_xres_ver() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return xres_ver_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline std::string* xresloader_header::release_data_ver() {
  ...
  _has_bits_[0] &= ~0x00000002u;
  return data_ver_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline std::string* xresloader_header::release_hash_code() {
  ...
  _has_bits_[0] &= ~0x00000004u;
  return hash_code_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
...
inline std::string* xresloader_datablocks::release_data_message_type() {
  ...
  _has_bits_[0] &= ~0x00000001u;
  return data_message_type_.ReleaseNonDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), GetArenaForAllocation());
}
