...
inline std::string* xresloader_header::release_xres_ver() {
  ...
  return xres_ver_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
inline std::string* xresloader_header::release_data_ver() {
  ...
  return data_ver_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
...
inline std::string* xresloader_header::release_hash_code() {
  ...
  return hash_code_.ReleaseNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
