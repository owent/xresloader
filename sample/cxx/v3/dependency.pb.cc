...
PROTOBUF_CONSTINIT ::google::protobuf::internal::ReflectionData
    file_reflection_data[] = {
        // ::dep_cfg
        {&::_pbi::kDescriptorMethods, &::descriptor_table_dependency_2eproto, /* tracker*/ nullptr,},
};
}  // namespace
#endif
...
constexpr dep_cfg::ParseTableT_ dep_cfg::InternalGenerateParseTable_(const ::_pbi::ClassData* class_data) {
  return ParseTableT_{
    {
      ...
      // uint32 id = 1;
      {::_pbi::TcParser::SingularVarintNoZag1<::uint32_t, offsetof(dep_cfg, _impl_.id_), 2>(),
       {8, 2, 0,
      ...
      // uint32 id = 1;
      {PROTOBUF_FIELD_OFFSET(dep_cfg, _impl_.id_), _Internal::kHasBitsOffset + 2, 0, (0 | ::_fl::kFcOptional | ::_fl::kUInt32)},
      // string name = 2;
      {PROTOBUF_FIELD_OFFSET(dep_cfg, _impl_.name_), _Internal::kHasBitsOffset + 0, 0, (0 | ::_fl::kFcOptional | ::_fl::kUtf8String | ::_fl::kRepAString)},
      // .dep2_cfg dep2 = 3;
      {PROTOBUF_FIELD_OFFSET(dep_cfg, _impl_.dep2_), _Internal::kHasBitsOffset + 1, 0, (0 | ::_fl::kFcOptional | ::_fl::kMessage | ::_fl::kTvTable)},
    }},
    {{
...
template <typename>
constexpr dep_cfg::dep_cfg(::_pbi::ConstantInitialized,
...
inline void* PROTOBUF_NONNULL dep_cfg::PlacementNew_(
    const void* PROTOBUF_NONNULL, void* PROTOBUF_NONNULL mem,
    ::google::protobuf::Arena* PROTOBUF_NULLABLE arena) {
  return ::new (mem) dep_cfg(arena);
}
constexpr auto dep_cfg::InternalNewImpl_() {
  return ::google::protobuf::internal::MessageCreator::CopyInit(sizeof(dep_cfg), alignof(dep_cfg));
}
constexpr auto dep_cfg::InternalGenerateClassData_(
  ...
  return ::google::protobuf::internal::ClassDataFull{
      ::google::protobuf::internal::ClassData{
          ...
          &dep_cfg::MergeImpl,
          Super_::GetNewImpl<dep_cfg>(),
#if defined(PROTOBUF_CUSTOM_VTABLE)
          &dep_cfg::SharedDtor,
          Super_::GetClearImpl<dep_cfg>(), &dep_cfg::ByteSizeLong,
...
struct dep_cfgGlobalsTypeInternal : ::_pbi::MessageGlobalsBase {
  constexpr dep_cfgGlobalsTypeInternal()
      :
#ifndef PROTOBUF_MESSAGE_GLOBALS
        _default(::_pbi::ConstantInitialized{},
                 dep_cfg_class_data_.base())
#else   // !PROTOBUF_MESSAGE_GLOBALS
        MessageGlobalsBase(dep_cfg::InternalGenerateClassData_(
            _default, &dep_cfg_globals_._table.header)),
        _default(::_pbi::ConstantInitialized{}, GetClassData()),
        _table(::_pbi::PrivateAccess::GenerateParseTable<dep_cfg>(
            GetClassData()))
#endif  // PROTOBUF_MESSAGE_GLOBALS
  {
  }
  ~dep_cfgGlobalsTypeInternal() {}
  union {
    alignas(::_pbi::kMaxMessageAlignment) dep_cfg _default;
  };
#ifdef PROTOBUF_MESSAGE_GLOBALS
  decltype(::_pbi::PrivateAccess::GenerateParseTable<dep_cfg>(
      ::std::declval<const ::_pbi::ClassData*>())) _table;
#endif
};
#ifdef PROTOBUF_MESSAGE_GLOBALS
static_assert(PROTOBUF_FIELD_OFFSET(dep_cfgGlobalsTypeInternal, _default) ==
              ::_pbi::MessageGlobalsBase::OffsetToDefault());
#endif  // PROTOBUF_MESSAGE_GLOBALS

PROTOBUF_ATTRIBUTE_NO_DESTROY PROTOBUF_CONSTINIT
    PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 PROTOBUF_MESSAGE_GLOBALS_CONST dep_cfgGlobalsTypeInternal dep_cfg_globals_
        PROTOBUF_MESSAGE_GLOBALS_SECTION(.data.rel.ro);
#if defined(PROTOBUF_CUSTOM_VTABLE)
namespace {
const ::_pbi::ClassData* dep_cfg_get_class_data() {
#ifdef PROTOBUF_MESSAGE_GLOBALS
  return dep_cfg_globals_.GetClassData();
#else
  return dep_cfg_class_data_.base();
#endif  // PROTOBUF_MESSAGE_GLOBALS
}
}  // namespace
#endif  // PROTOBUF_CUSTOM_VTABLE
static const ::_pb::EnumDescriptor* PROTOBUF_NONNULL
    file_level_enum_descriptors_dependency_2eproto[2];
...
static const ::_pbi::DescriptorTable* PROTOBUF_NONNULL const
    descriptor_table_dependency_2eproto_deps[2] = {
...
dep_cfg::dep_cfg(::google::protobuf::Arena* PROTOBUF_NULLABLE arena)
#if defined(PROTOBUF_CUSTOM_VTABLE)
    : Super_(arena, dep_cfg_get_class_data()) {
...
PROTOBUF_NDEBUG_INLINE dep_cfg::Impl_::Impl_(
    [[maybe_unused]] ::google::protobuf::internal::InternalVisibility visibility,
    [[maybe_unused]] ::google::protobuf::Arena* PROTOBUF_NULLABLE arena, const Impl_& from,
    [[maybe_unused]] const ::dep_cfg& from_msg)
...
dep_cfg::dep_cfg(
  ...
  _impl_.dep2_ = (CheckHasBit(cached_has_bits, 0x00000002U))
                 ? Super_::CopyConstruct(arena, *from._impl_.dep2_)
                 : nullptr;
...
inline void dep_cfg::SharedCtor(::_pb::Arena* PROTOBUF_NULLABLE arena) {
...
inline void dep_cfg::SharedDtor(MessageLite& self) {
  dep_cfg& this_ = static_cast<dep_cfg&>(self);
  ...
  delete this_._impl_.dep2_;
  this_._impl_.~Impl_();
}

#ifndef PROTOBUF_MESSAGE_GLOBALS
PROTOBUF_CONSTINIT PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const
    ::google::protobuf::internal::ClassDataFull dep_cfg_class_data_ =
        dep_cfg::InternalGenerateClassData_(dep_cfg_globals_._default);

PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
dep_cfg::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&dep_cfg_class_data_);
  ::google::protobuf::internal::PrefetchToLocalCache(dep_cfg_class_data_.tc_table);
  return dep_cfg_class_data_.base();
}
#else
PROTOBUF_ATTRIBUTE_WEAK const ::google::protobuf::internal::ClassData* PROTOBUF_NONNULL
dep_cfg::GetClassData() const {
  ::google::protobuf::internal::PrefetchToLocalCache(&dep_cfg_globals_);
  ::google::protobuf::internal::PrefetchToLocalCache(
      ::google::protobuf::internal::MessageGlobalsBase::ToParseTableBase(&dep_cfg_globals_));
  return dep_cfg_globals_.GetClassData();
}
#endif  // !PROTOBUF_MESSAGE_GLOBALS
#ifndef PROTOBUF_MESSAGE_GLOBALS
PROTOBUF_CONSTINIT
PROTOBUF_ATTRIBUTE_INIT_PRIORITY1 const dep_cfg::ParseTableT_
    dep_cfg::_table_ =
        dep_cfg::InternalGenerateParseTable_(dep_cfg_class_data_.base());
#endif  // !PROTOBUF_MESSAGE_GLOBALS
PROTOBUF_NOINLINE void dep_cfg::Clear() {
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x00000003U)) {
    ...
    if (CheckHasBit(cached_has_bits, 0x00000002U)) {
      ABSL_DCHECK(this_._impl_.dep2_ != nullptr);
      this_._impl_.dep2_->Clear();
    }
  }
  this_._impl_.id_ = 0u;
...
#if defined(PROTOBUF_CUSTOM_VTABLE)
::uint8_t* PROTOBUF_NONNULL dep_cfg::_InternalSerialize(
...
void dep_cfg::MergeImpl(::google::protobuf::MessageLite& to_msg,
  ...
  if (BatchCheckHasBit(cached_has_bits, 0x00000007U)) {
    ...
    if (CheckHasBit(cached_has_bits, 0x00000002U)) {
      ...
      if (_this->_impl_.dep2_ == nullptr) {
        _this->_impl_.dep2_ = Super_::CopyConstruct(arena, *from._impl_.dep2_);
      } else {
...
void dep_cfg::InternalSwap(dep_cfg* PROTOBUF_RESTRICT PROTOBUF_NONNULL other) {
  using ::std::swap;
  auto* arena = GetArena();
