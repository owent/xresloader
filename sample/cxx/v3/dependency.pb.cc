...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_dependency_2eproto = {
  false, false, 550, descriptor_table_protodef_dependency_2eproto, "dependency.proto", 
...
void dep_cfg::clear_dep2() {
  if (GetArenaForAllocation() == nullptr && dep2_ != nullptr) {
    delete dep2_;
  }
  dep2_ = nullptr;
}
    ...
    switch (tag >> 3) {
      ...
      case 2:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 18)) {
          ...
          CHK_(::PROTOBUF_NAMESPACE_ID::internal::VerifyUTF8(str, "dep_cfg.name"));
          CHK_(ptr);
        } else
          goto handle_unusual;
        continue;
