...
inline bool game_const_config_IsValid(int value) {
...
const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL game_const_config_descriptor();
template <typename T>
...
inline bool cost_type_IsValid(int value) {
...
const ::google::protobuf::EnumDescriptor* PROTOBUF_NONNULL cost_type_descriptor();
template <typename T>
...
/* @@protoc_insertion_point(class_definition:dep_cfg) */ {
 public:
  ...
  explicit PROTOBUF_CONSTEXPR dep_cfg(::google::protobuf::internal::ConstantInitialized);
  ...
  dep_cfg* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
