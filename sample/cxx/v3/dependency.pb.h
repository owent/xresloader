...
PROTOBUF_NAMESPACE_OPEN
template <>
::dep_cfg* Arena::CreateMaybeMessage<::dep_cfg>(Arena*);
PROTOBUF_NAMESPACE_CLOSE
...
const std::string& game_const_config_Name(T value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(game_const_config_descriptor(), value);
}
...
const std::string& cost_type_Name(T value) {
  ...
  return ::PROTOBUF_NAMESPACE_ID::internal::NameOfEnum(cost_type_descriptor(), value);
}
