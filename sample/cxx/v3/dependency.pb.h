...
enum game_const_config : int {
  ...
  game_const_config_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::min(),
  game_const_config_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<::PROTOBUF_NAMESPACE_ID::int32>::max()
};
...
inline std::string* dep_cfg::unsafe_arena_release_name() {
  // @@protoc_insertion_point(field_unsafe_arena_release:dep_cfg.name)
  GOOGLE_DCHECK(GetArena() != nullptr);
  
  return name_.UnsafeArenaRelease(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      GetArena());
}
inline void dep_cfg::unsafe_arena_set_allocated_name(
    std::string* name) {
  GOOGLE_DCHECK(GetArena() != nullptr);
  if (name != nullptr) {
  ...
  name_.UnsafeArenaSetAllocated(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      name, GetArena());
  // @@protoc_insertion_point(field_unsafe_arena_set_allocated:dep_cfg.name)
}

// .dep2_cfg dep2 = 3;
inline bool dep_cfg::_internal_has_dep2() const {
  return this != internal_default_instance() && dep2_ != nullptr;
}
...
inline ::dep2_cfg* dep_cfg::release_dep2() {
  auto temp = unsafe_arena_release_dep2();
  if (GetArena() != nullptr) {
...
inline ::dep2_cfg* dep_cfg::_internal_mutable_dep2() {
  ...
  if (dep2_ == nullptr) {
    auto* p = CreateMaybeMessage<::dep2_cfg>(GetArena());
    dep2_ = p;
  }
  return dep2_;
}
...
inline void dep_cfg::set_allocated_dep2(::dep2_cfg* dep2) {
  ...
  if (dep2) {
    ::PROTOBUF_NAMESPACE_ID::Arena* submessage_arena =
      reinterpret_cast<::PROTOBUF_NAMESPACE_ID::MessageLite*>(dep2)->GetArena();
