...
class dep_cfg : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:dep_cfg) */ {
 public:
  ...
  static const dep_cfg* internal_default_instance();
  ...
  void UnsafeMergeFrom(const dep_cfg& from);
  private:
 ...
 private:
  ...
  friend void  protobuf_InitDefaults_dependency_2eproto_impl();
...
extern ::google::protobuf::internal::ExplicitlyConstructed<dep_cfg> dep_cfg_default_instance_;
