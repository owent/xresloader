...
void test_msg_verifier::CheckTypeAndMergeFrom(
    const ::google::protobuf::MessageLite& from) {
  MergeFrom(*::google::protobuf::down_cast<const test_msg_verifier*>(&from));
}
...
::std::string test_msg_verifier::GetTypeName() const {
