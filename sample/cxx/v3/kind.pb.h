...
enum arr_in_arr_test_nested_message_test_nested_enum : int {
  ...
  arr_in_arr_test_nested_message_test_nested_enum_arr_in_arr_test_nested_message_test_nested_enum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  arr_in_arr_test_nested_message_test_nested_enum_arr_in_arr_test_nested_message_test_nested_enum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
enum arr_in_arr_test_nested_enum : int {
  ...
  arr_in_arr_test_nested_enum_arr_in_arr_test_nested_enum_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  arr_in_arr_test_nested_enum_arr_in_arr_test_nested_enum_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class role_cfg final :
 ...
 private:
  ...
  struct Impl_ {
    ...
    mutable std::atomic<int> _test_plain_enum_array_cached_byte_size_;
...
class process_by_script final :
 ...
 public:
  ...
  template <typename ArgT0 = const std::string&, typename... ArgT>
  void set_human_readable_date(ArgT0&& arg0, ArgT... args);
  std::string* mutable_human_readable_date();
  PROTOBUF_NODISCARD std::string* release_human_readable_date();
  void set_allocated_human_readable_date(std::string* human_readable_date);
  private:
  const std::string& _internal_human_readable_date() const;
  inline PROTOBUF_ALWAYS_INLINE void _internal_set_human_readable_date(const std::string& value);
...
inline bool role_cfg::_internal_has_dep_test() const {
  return this != internal_default_instance() && _impl_.dep_test_ != nullptr;
}
...
inline bool role_cfg::_internal_has_convert_timepoint_one() const {
  return this != internal_default_instance() && _impl_.convert_timepoint_one_ != nullptr;
}
...
inline bool role_cfg::_internal_has_convert_duration_one() const {
  return this != internal_default_instance() && _impl_.convert_duration_one_ != nullptr;
}
...
inline bool arr_in_arr_cfg::_internal_has_test_plain_msg() const {
  return this != internal_default_instance() && _impl_.test_plain_msg_ != nullptr;
}
...
inline bool event_cfg::_internal_has_specify_field() const {
  return this != internal_default_instance() && _impl_.specify_field_ != nullptr;
}
...
template <typename ArgT0, typename... ArgT>
inline PROTOBUF_ALWAYS_INLINE
void process_by_script::set_human_readable_date(ArgT0&& arg0, ArgT... args) {
 
 _impl_.human_readable_date_.Set(static_cast<ArgT0 &&>(arg0), args..., GetArenaForAllocation());
...
inline void process_by_script::set_allocated_human_readable_date(std::string* human_readable_date) {
  if (human_readable_date != nullptr) {
    
  } else {
    
  }
  _impl_.human_readable_date_.SetAllocated(human_readable_date, GetArenaForAllocation());
#ifdef PROTOBUF_FORCE_COPY_DEFAULT_STRING
...
// .google.protobuf.Timestamp date = 4;
inline bool process_by_script::_internal_has_date() const {
...
inline bool process_by_script::_internal_has_id_id() const {
  return this != internal_default_instance() && _impl_.id_id_ != nullptr;
}
inline bool process_by_script::has_id_id() const {
  return _internal_has_id_id();
}
inline void process_by_script::clear_id_id() {
  if (GetArenaForAllocation() == nullptr && _impl_.id_id_ != nullptr) {
