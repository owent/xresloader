...
inline bool arr_in_arr_test_nested_message_test_nested_enum_IsValid(int value) {
...
inline bool arr_in_arr_test_nested_enum_IsValid(int value) {
...
/* @@protoc_insertion_point(class_definition:arr_in_arr.test_nested_message) */ {
 public:
  ...
  template <typename = void>
  explicit PROTOBUF_CONSTEXPR arr_in_arr_test_nested_message(::google::protobuf::internal::ConstantInitialized);
  ...
  arr_in_arr_test_nested_message* PROTOBUF_NONNULL New(::google::protobuf::Arena* PROTOBUF_NULLABLE arena = nullptr) const {
 ...
 public:
  ...
  static inline bool test_nested_enum_Parse(
