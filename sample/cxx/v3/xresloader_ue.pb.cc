...
static bool descriptor_table_xresloader_5fue_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_xresloader_5fue_2eproto = {
  &descriptor_table_xresloader_5fue_2eproto_initialized, descriptor_table_protodef_xresloader_5fue_2eproto, "xresloader_ue.proto", 351,
...
static bool dynamic_init_dummy_xresloader_5fue_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_xresloader_5fue_2eproto), true);
namespace org {
namespace xresloader {
namespace ue {
