...
foreach ($proto_dir in "proto_v2", "proto_v3") {
    ...
    $TASK_LINES = @(
        ...
        "-t lua -o '$proto_dir' -f '$proto_dir/kind.pb' --pretty 2 -c kind_option.lua",
        "-t lua -o '$proto_dir' -f '$proto_dir/kind.pb' --pretty 2 --lua-module ProtoOptions.Kind -c kind_option.lua",
        "-t js -o '$proto_dir' -f '$proto_dir/kind.pb' --pretty 2 -c kind_option.js --javascript-export nodejs",
