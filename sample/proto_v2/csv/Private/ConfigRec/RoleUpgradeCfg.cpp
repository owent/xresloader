...
void URoleUpgradeCfgHelper::InitializeDefaultLoader() const
{
    ...
    const_cast<URoleUpgradeCfgHelper*>(this)->SetLoader(MakeShareable(new ConstructorHelpers::FObjectFinder<UDataTable>(TEXT("DataTable'/Game/ConfigRec/RoleUpgradeCfgRec'"))));
}
