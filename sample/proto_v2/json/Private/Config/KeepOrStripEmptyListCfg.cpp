 ...
 */
#include "Config/KeepOrStripEmptyListCfg.h"
...
void UKeepOrStripEmptyListCfgHelper::InitializeDefaultLoader() const
{
    ...
    const_cast<UKeepOrStripEmptyListCfgHelper*>(this)->SetLoader(MakeShareable(new ConstructorHelpers::FObjectFinder<UDataTable>(TEXT("DataTable'/Game/Config/KeepEmptyListCfg'"))));
}
