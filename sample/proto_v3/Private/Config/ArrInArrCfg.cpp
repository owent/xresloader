...
UArrInArrCfgHelper::UArrInArrCfgHelper() : Super()
{
    ...
    this->Empty.Name = 0;
    this->Empty.Id = 0;
    this->Empty.Arr_0_Name = TEXT("");
    this->Empty.Arr_0_IntArr_0 = 0;
    this->Empty.Arr_0_IntArr_1 = 0;
    this->Empty.Arr_0_StrArr_0 = TEXT("");
    this->Empty.Arr_0_StrArr_1 = TEXT("");
    this->Empty.Arr_1_Name = TEXT("");
    this->Empty.Arr_1_IntArr_0 = 0;
    this->Empty.Arr_1_IntArr_1 = 0;
    this->Empty.Arr_1_StrArr_0 = TEXT("");
    this->Empty.Arr_1_StrArr_1 = TEXT("");
