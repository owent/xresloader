...
void UEventCfgHelper::InitializeDefaultLoader() const
{
    ...
    const_cast<UEventCfgHelper*>(this)->SetLoader(MakeShareable(new ConstructorHelpers::FObjectFinder<UDataTable>(GetObjectPath())));
}
...
const TCHAR* UEventCfgHelper::GetObjectPath() const
{
    return TEXT("DataTable'/Game/ConfigRec/EventCfgRec'");
}

FName UEventCfgHelper::GetRowName(FName Name)
{
    return *FString::Printf(TEXT("%lld"), static_cast<long long>(Name));
}

FName UEventCfgHelper::GetDataRowName(FName Name) const
{
    return UEventCfgHelper::GetRowName(Name);
}
...
const FEventCfg& UEventCfgHelper::GetDataRowByKey(FName Name, bool& IsValid) const
{
...
void UEventCfgHelper::ClearRow(FEventCfg& TableRow)
{
    ...
    TableRow.Rule.NestedEnumType = ECostType::EnCtUnknown;
    ...
    TableRow.SpecifyField.NestedEnumType = ECostType::EnCtUnknown;
    TableRow.Item.ItemId = 0;
    TableRow.Item.ItemCount = 0;
    TableRow.Item.Nested = TEXT("");
    TableRow.Item.NestedNote = TEXT("");
    TableRow.Item.NestedEnumType = ECostType::EnCtUnknown;
    TableRow.UserExp = 0;
    TableRow.Note = TEXT("");
    TableRow.EnumType = ECostType::EnCtUnknown;
