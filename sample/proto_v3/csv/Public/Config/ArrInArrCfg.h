/**
 * This file is generated by xresloader 2.10.0-rc2, please don't edit it.
...
struct FArrInArrCfg : public FTableRowBase
{
    ...
    /** Field Type: INT, Name: TestMapIs_0_Key, Index: 1 **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
    int32 TestMapIs_0_Key;

    /** Field Type: STRING, Name: TestMapIs_0_Value, Index: 2 **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
    FString TestMapIs_0_Value;

    /** Field Type: INT, Name: TestMapIs_1_Key, Index: 1 **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
    int32 TestMapIs_1_Key;

    /** Field Type: STRING, Name: TestMapIs_1_Value, Index: 2 **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
    FString TestMapIs_1_Value;
