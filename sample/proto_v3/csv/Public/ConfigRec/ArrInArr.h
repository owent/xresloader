...
struct FArrInArr : public FTableRowBase
{
    ...
    /** Field Type: MESSAGE, Name: TestInfoRole, Index: 11. This field is generated for UE Editor compatible. **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
    FRoleCfg TestInfoRole;

    /** Field Type: MESSAGE, Name: TestRoleUpgradeCfg, Index: 12. This field is generated for UE Editor compatible. **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
