...
struct FArrInArrCfg : public FTableRowBase
{
    ...
    /** Field Type: FArrInArr, Name: Arr, Index: 2. This field is generated for UE Editor compatible. **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
    TArray< FArrInArr > Arr;

    /** Field Type: int32, Name: TestPlainIntArr, Index: 3. This field is generated for UE Editor compatible. **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
    TArray< int32 > TestPlainIntArr;

    /** Field Type: ECostType, Name: TestPlainEnumArr, Index: 4. This field is generated for UE Editor compatible. **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
    TArray< ECostType > TestPlainEnumArr;

    /** Field Type: FTestMsgVerifier, Name: TestPlainMsg, Index: 5. This field is generated for UE Editor compatible. **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
    FTestMsgVerifier TestPlainMsg;

    /** Field Type: FTestMsgVerifier, Name: TestPlainMsgArr, Index: 6. This field is generated for UE Editor compatible. **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
    TArray< FTestMsgVerifier > TestPlainMsgArr;

    /** Field Type: FTestMapIsEntry, Name: TestMapIs, Index: 7. This field is generated for UE Editor compatible. **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
    TMap< int32, FString > TestMapIs;

    /** Field Type: FTestMapSmEntry, Name: TestMapSm, Index: 8. This field is generated for UE Editor compatible. **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
