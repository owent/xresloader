...
struct FKeepOrStripEmptyListCfg : public FTableRowBase
{
    ...
    /** Field Type: FDep2Cfg, Name: ArrayMsg, Index: 2. This field is generated for UE Editor compatible. **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
    TArray< FDep2Cfg > ArrayMsg;

    /** Field Type: FDep2Cfg, Name: ArrayPlainMsg, Index: 3. This field is generated for UE Editor compatible. **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
    TArray< FDep2Cfg > ArrayPlainMsg;

    /** Field Type: int32, Name: ArrayInt32, Index: 4. This field is generated for UE Editor compatible. **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
    TArray< int32 > ArrayInt32;

    /** Field Type: int64, Name: ArrayInt64, Index: 5. This field is generated for UE Editor compatible. **/
    UPROPERTY(EditAnywhere, BlueprintReadOnly, Category = "XResConfig")
