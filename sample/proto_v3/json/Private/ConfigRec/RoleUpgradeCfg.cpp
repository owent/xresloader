...
{
    return TEXT("DataTable'/Game/ConfigRec/RoleUpgradeCfg'");
}

FName URoleUpgradeCfgHelper::GetRowName(FName Name)
{
    return *FString::Printf(TEXT("%lld"), static_cast<long long>(Name));
}

FName URoleUpgradeCfgHelper::GetDataRowName(FName Name) const
{
    return URoleUpgradeCfgHelper::GetRowName(Name);
}
...
const FRoleUpgradeCfg& URoleUpgradeCfgHelper::GetDataRowByKey(FName Name, bool& IsValid) const
{
