...
(function(){
  ...
  try { extend(window, { "role_cfg_header" : local_data_set }); }
  catch(e) { extend(global, { "role_cfg_header" : local_data_set }); }
  ...
  try { extend(window, { "role_cfg" : local_data_set }); }
  catch(e) { extend(global, { "role_cfg" : local_data_set }); }
