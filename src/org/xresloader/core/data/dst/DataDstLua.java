...
public class DataDstLua extends DataDstJava {
    ...
    public final byte[] build(DataDstImpl compiler) throws ConvException {
        ...
        if (isUsingLuaModule()) {
            ...
            sb.append(String.format("module(\"%s.%s\", package.seeall)", ProgramOptions.getInstance().luaModule, mod_name)).append(getSystemEndl());
            sb.append("-- this file is generated by xresloader, please don't edit it.").append(getSystemEndl()).append(endl);
    ...
    public final byte[] dumpConst(HashMap<String, Object> data) throws ConvException, IOException {
        ...
        if (isUsingLuaModule()) {
            sb.append(String.format("module(\"%s\", package.seeall)", ProgramOptions.getInstance().luaModule)).append(getSystemEndl());
            sb.append("-- this file is generated by xresloader, please don't edit it.").append(getSystemEndl()).append(endl);
        } else {
            sb.append("-- this file is generated by xresloader, please don't edit it.").append(getSystemEndl()).append(endl);
        }
